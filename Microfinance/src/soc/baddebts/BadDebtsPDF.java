...
public class BadDebtsPDF {
	...
	public BadDebtsPDF(ResultSet rs, Statement stm, JTable jtable, double sum) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.sum = sum;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Bad Debts Report Generated",
			...
			PdfPCell cell = new PdfPCell(new Paragraph(
					"Bad Debts ".toUpperCase() + tablename.toUpperCase() + ". SUM: $" + sum,
