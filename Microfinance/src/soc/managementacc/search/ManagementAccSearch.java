package soc.managementacc.search;
 ...
 *
 */
public class ManagementAccSearch {
	...
	public ManagementAccSearch(ResultSet rs, Statement stm, JFrame frame) {
		this.stm = stm;
		this.rs = rs;
		this.frame = frame;
		df = new DoubleForm();
	...
	public void search(String date, String date1, JTextArea display) {
		String text = "SELECT * FROM management_acc WHERE date BETWEEN '" + date + "' AND '" + date1
