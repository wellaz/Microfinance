...
public class InstallmentsPDF {
	...
	String date, date1;
	int acc;
	public InstallmentsPDF(ResultSet rs, Statement stm, JTable jtable, String date, String date1,int acc) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Acccount "+acc+"Installments Statement Generated",
			...
			for (int i = 0; i < jtable.getColumnCount(); i++) {
				...
				table.addCell(new Phrase(InstallmentHeader.header[i],
