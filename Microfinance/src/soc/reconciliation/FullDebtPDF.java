...
public class FullDebtPDF {
	...
	public FullDebtPDF(ResultSet rs, Statement stm, JTable jtable, String date, String date1) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Full Debts Payments Report Generated",
			...
			for (int i = 0; i < jtable.getColumnCount(); i++) {
				...
				table.addCell(new Phrase(FullDebtsHeader.header[i],
