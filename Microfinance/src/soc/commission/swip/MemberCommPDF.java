...
public class MemberCommPDF {
	...
	public MemberCommPDF(ResultSet rs, Statement stm, JTable jtable, String date) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Commission Sweep Report Generated",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("-----------------------------",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("Month : " + date,
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("------------------------------- ",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			...
			PdfPCell cell = new PdfPCell(new Paragraph("Commission Sweep".toUpperCase(),
			...
			for (int i = 0; i < jtable.getColumnCount(); i++) {
				...
				table.addCell(new Phrase(SwipHeader.header[i],
