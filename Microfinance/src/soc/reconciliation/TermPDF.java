...
public class TermPDF {
	...
	public TermPDF(ResultSet rs, Statement stm, JTable jtable, String date, String date1) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Member Termination Report Generated",
			...
			for (int i = 0; i < jtable.getColumnCount(); i++) {
				...
				table.addCell(new Phrase(TermHeader.header[i],
