...
public class RecoPDF {
	String name, acc;

	JTable jtable1;

	public RecoPDF(JTable jtable1, String name, String acc) {
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("-----------------------------",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("Micro - Reconciliation Statement  For " + name.toUpperCase() + " Acc :" + acc,
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("-------------------------------- ",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			...
			PdfPCell cell1 = new PdfPCell(new Paragraph("Micro - Reconciliation Statement".toUpperCase(),
			...
			for (int i = 0; i < jtable1.getColumnCount(); i++) {
				...
				table1.addCell(new Phrase(RecoHeader.header[i],
