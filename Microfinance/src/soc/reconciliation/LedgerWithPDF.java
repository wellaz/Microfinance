...
public class LedgerWithPDF {
	...
	public LedgerWithPDF(ResultSet rs, Statement stm, JTable jtable, String date, String date1) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Investors Withdrawals Report Generated",
			...
			for (int i = 0; i < jtable.getColumnCount(); i++) {
				...
				table.addCell(new Phrase(CommissionsHeader.header[i],
