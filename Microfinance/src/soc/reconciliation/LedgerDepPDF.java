...
public class LedgerDepPDF {
	...
	public LedgerDepPDF(ResultSet rs, Statement stm, JTable jtable, String date, String date1) {
		this.rs = rs;
		this.stm = stm;
		this.jtable = jtable;
		this.date = date;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Investors Deposits Report Generated",
